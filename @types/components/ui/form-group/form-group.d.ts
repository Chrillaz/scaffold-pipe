 ...
 * ```
 */
declare const ConnectedFormGroup: import("../context").PolymorphicComponent<import("react").ElementType<any>, import("../context").PolymorphicComponentProps<import("./types").FormGroupProps, "div">>;
