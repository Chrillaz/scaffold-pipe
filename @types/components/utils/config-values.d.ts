declare namespace _default {
    ...
    export { CARD_PADDING_X as cardPaddingX };
    export { CARD_PADDING_Y as cardPaddingY };
    export const cardPadding: string;
    export const cardHeaderFooterPaddingY: string;
    export const cardHeaderHeight: string;
...
declare const CARD_PADDING_X: string;
declare const CARD_PADDING_Y: string;
